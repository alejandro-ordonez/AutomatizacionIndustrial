...
IGuiDialogView
{
	...
	IGuiIOField
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q33554436,33554436)
		}
	}
	IGuiTextField
	{
	...
	IGuiIOField
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q33554437,33554437)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539285,486539285)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539286,486539286)
		}
	}
	IGuiGraphicButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539287,486539287)
		}
	}
	IGuiQmlRectangle
	{
	...
	Component.onCompleted:
	{
		proxy.initProxy(q687865856,687865856)
	}
}
