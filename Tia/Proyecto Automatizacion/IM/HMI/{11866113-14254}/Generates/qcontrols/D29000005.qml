...
IGuiDialogView
{
	...
	IGuiTextField
	{
		...
		{
			proxy.initProxy(q268435458,268435458)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539272,486539272)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539273,486539273)
		}
	}
	IGuiGraphicButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539274,486539274)
		}
	}
	IGuiQmlRectangle
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q671088643,671088643)
		}
	}
	Component.onCompleted:
	{
		proxy.initProxy(q687865861,687865861)
	}
}
