...
IGuiDialogView
{
	...
	qm_DisplayText: "La contraseña caduca en: %0 día(s)"
	modalityWidth: 320
	modalityHeight: 252
	IGuiModality{ }
	IGuiTextField
	{
		...
		{
			proxy.initProxy(q268435461,268435461)
		}
	}
	IGuiIOField
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q33554434,33554434)
		}
	}
	IGuiTextField
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q268435462,268435462)
		}
	}
	IGuiIOField
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q33554435,33554435)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539282,486539282)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539283,486539283)
		}
	}
	IGuiGraphicButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539284,486539284)
		}
	}
	IGuiQmlRectangle
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q671088646,671088646)
		}
	}
	Component.onCompleted:
	{
		proxy.initProxy(q687865864,687865864)
	}
}
