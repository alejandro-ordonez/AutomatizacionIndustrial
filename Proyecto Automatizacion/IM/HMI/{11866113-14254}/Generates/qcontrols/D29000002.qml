...
IGuiDialogView
{
	...
	width: 1024
	height: 768
	qm_FillRectWidth: 1024
	qm_FillRectHeight: 768
	qm_FontSize: 8
	...
	qm_DisplayText: "Texto completo del aviso"
	modalityWidth: -224
	modalityHeight: -288
	IGuiModality{ }
	IGuiGraphicButton
	{
		...
		{
			proxy.initProxy(q486539264,486539264)
		}
	}
	Component.onCompleted:
	{
		proxy.initProxy(q687865858,687865858)
	}
}
