...
IGuiSwitchBitMap{
    ...
    function setStatusValue(value )
    {
        ...
        if(value === qm_SwitchOnValue)
        {
            ...
            {
                sliderRect.y = qSliderSwitchView.height/2;
    ...
    Rectangle{
        id:textLeftRect
        height:qSliderSwitchView.height/2+qSliderSwitchView.qm_BorderWidth
        width:qSliderSwitchView.width
        color: "transparent"
    ...
    Rectangle{
        id:textRightRect
        y:qSliderSwitchView.height/2- qSliderSwitchView.qm_BorderWidth
        height:qSliderSwitchView.height/2+qSliderSwitchView.qm_BorderWidth
        width:qSliderSwitchView.width
        color: "transparent"
        border.color: "transparent"
    ...
    Item
    {
        id: sliderRect
        width:qSliderSwitchView.width
        height:qSliderSwitchView.height/2
        Rectangle{
        ...
        BorderImage{
            ...
            width :(tileWidth > (parent.height/2 - qm_BorderWidth))?(parent.height/2 -qm_BorderWidth):tileWidth
            rotation: 90
            anchors.centerIn: parent
        ...
        MouseArea {
            ...
            drag.minimumY: 0
            drag.maximumY: qSliderSwitchView.height/2
