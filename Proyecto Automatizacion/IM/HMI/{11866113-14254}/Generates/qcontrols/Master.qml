...
Item{
   ...
   // signal vkescapeClicked()
    ...
    function start()
    {
        ...
        if(screenSize ==="12")
        {
            qm_SoftKeypadHeight=landscapeMode?style.twelveInch_SoftKeypadHeight:style.twelveInch_SoftKeypadWidth
            qm_SoftKeypadWidth=landscapeMode?style.twelveInch_SoftKeypadWidth:style.twelveInch_SoftKeypadHeight
            qm_buttonWidth = landscapeMode?style.twelveInch_buttonWidth:style.twelveInch_PortraitModebuttonWidth
            qm_buttonHeight = landscapeMode?style.twelveInch_buttonHeight:style.twelveInch_PortraitModebuttonHeight
            ...
            qm_buttonWidthForNumericKeypad = landscapeMode?style.twelveInch_buttonWidthForNumericKeypad:style.twelveInch_PortraitMode_buttonWidthForNumericKeypad
            qm_buttonHeightForNumericKeypad = landscapeMode?style.twelveInch_buttonHeightForNumericKeypad:style.twelveInch_PortraitMode_buttonHeightForNumericKeypad
