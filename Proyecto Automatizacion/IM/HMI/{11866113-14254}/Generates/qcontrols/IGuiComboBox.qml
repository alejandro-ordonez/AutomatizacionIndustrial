...
IGuiViewBitmap
{
    ...
    property string qm_DownButton : "image://QSmartImageProvider/" + qm_GraphicImageId
    ...
    //Default QT color for text background color
    property color qm_DisplayTextBackColor : "#000080"
    //Default QT color for text foreground color
    property color qm_DisplayTextForeColor : "white"
        ...
        if(bSelectStatus && qm_SmartFocus)
        {
            if(!qm_InEditMode)
            {
                ...
                if(qm_ComboType === 1)
                {
                    ...
                    qm_DisplayTextForeColor = qm_SymIOSelForeColor
                    qm_DisplayTextBackColor = qm_SymIOSelBackFillColor
            ...
            else if ((qm_DisplayTextForeColor == qm_SymIOSelForeColor) && (qm_SymIOType === 2))
            {
                qDisplayText.selectAll()
            }
        }
    ...
    TextInput
    {
        ...
        anchors.bottomMargin: qComboBoxView.qm_MarginBottom + qComboBoxView.qm_BorderWidth
        anchors.leftMargin: qComboBoxView.qm_MarginLeft + qComboBoxView.qm_BorderWidth
        anchors.rightMargin:(qm_IsDownButtonVisible == false)? (qComboBoxView.qm_MarginRight + qComboBoxView.qm_BorderWidth)
                                      : (qComboBoxView.qm_MarginRight + qComboBoxView.qm_BorderWidth+qm_HotAreaWidth)
        anchors.topMargin: qComboBoxView.qm_MarginTop + qComboBoxView.qm_BorderWidth
        horizontalAlignment: qComboBoxView.qm_ValueVarTextAlignmentHorizontal
        verticalAlignment: qComboBoxView.qm_ValueVarTextAlignmentVertical
        ...
        autoScroll: false
        selectedTextColor: qm_DisplayTextForeColor
        selectionColor: qm_DisplayTextBackColor
    }
    ...
    IGuiSmartSymIO{
        ...
        qm_NoOfVisibleEntries:qComboBoxView.qm_NoOfVisibleEntries
        qm_NoOfSymIoTextListItems:qComboBoxView.qm_NoOfSymIoTextListItems
        qm_tableRowHeight:qComboBoxView.qm_tableRowHeight
        qm_MarginTop:qComboBoxView.qm_MarginTop
        qm_MarginBottom:qComboBoxView.qm_MarginBottom
        qm_SymioHeight:qComboBoxView.height
        qm_SymioY:qComboBoxView.y
        qm_ParentHeight:parent.parent.height
        qm_ComboType:qComboBoxView.qm_ComboType
    }
    ...
    {
        id:qDownButtonRect
        x: (qComboBoxView.width -(qm_HotAreaWidth +qm_BorderWidth))
        height:qComboBoxView.height
