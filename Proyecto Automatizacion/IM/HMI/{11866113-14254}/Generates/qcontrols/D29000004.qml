...
IGuiDialogView
{
	...
	IGuiTextField
	{
		...
		{
			proxy.initProxy(q268435456,268435456)
		}
	}
	IGuiIOField
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q33554432,33554432)
		}
	}
	IGuiTextField
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q268435457,268435457)
		}
	}
	IGuiIOField
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q33554433,33554433)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539269,486539269)
		}
	}
	IGuiButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539270,486539270)
		}
	}
	IGuiGraphicButton
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q486539271,486539271)
		}
	}
	IGuiQmlRectangle
	{
		...
		Component.onCompleted:
		{
			proxy.initProxy(q671088642,671088642)
		}
	}
	Component.onCompleted:
	{
		proxy.initProxy(q687865860,687865860)
	}
}
