...
namespace AppPlanta.Service
{
...

    {
        ...
        //Add all the whole variables that indicates valves, buttons, etc, each variable should have a reference linked to plc memory
        //The best way is using a DB block that allows connections directly. In this first version it'll be used just one variable.
        ...
        //This method sets information require to make the connection.
        ...
        public async Task WriteStart(bool value)
